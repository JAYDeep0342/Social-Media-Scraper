...
from app.config.constants import (
    ...
    SCROLL_POLL_INTERVAL_SECONDS,
    SOCIAL_BROWSER_FETCH_TIMEOUT_SECONDS,
    SOCIAL_BROWSER_NETWORKIDLE_TIMEOUT_SECONDS,
    SOCIAL_SEARCH_RESULT_LIMIT,
    SOCIAL_SEARCH_TIMEOUT_SECONDS,
    VIEWPORT_HEIGHT,
    VIEWPORT_WIDTH,
)
...
class Settings(BaseSettings):
    ...
    SCROLL_POLL_INTERVAL_SECONDS: float = Field(default=SCROLL_POLL_INTERVAL_SECONDS, gt=0)
    ...
    SOCIAL_SEARCH_TIMEOUT_SECONDS: float = Field(default=SOCIAL_SEARCH_TIMEOUT_SECONDS, gt=0)
    SOCIAL_BROWSER_FETCH_TIMEOUT_SECONDS: float = Field(default=SOCIAL_BROWSER_FETCH_TIMEOUT_SECONDS, gt=0)
    SOCIAL_BROWSER_NETWORKIDLE_TIMEOUT_SECONDS: float = Field(
        default=SOCIAL_BROWSER_NETWORKIDLE_TIMEOUT_SECONDS, gt=0
    )
